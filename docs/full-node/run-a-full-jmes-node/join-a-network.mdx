...
If you are a developer and want to set up a local, WASM-enabled, private testnet for smart contracts, visit [install LocalJMES](../../develop/localjmes/README.mdx).
