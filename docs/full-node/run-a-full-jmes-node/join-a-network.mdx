...
You can either setup you own local private network or join a public network. If you want to join a public network (e.g. Testnet), you can skip to [join a public network](#join-a-public-network).
...
| :---------- | :------ | :------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- |                 |
| `jmes-testnet-1`   | Testnet | [Genesis Link](https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-testnet-1/genesis.json) |  Peer List Community maintained by [JMES](https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-testnet-1/addrbook.json) | [Seeds List](https://github.com/jmesworld/testnet) |
