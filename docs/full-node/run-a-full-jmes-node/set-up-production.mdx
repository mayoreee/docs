...
For information about running a validator node, visit the [validator guide](../manage-a-jmes-validator/README.mdx).
...
4. Now start the serivce with `systemctl start jmesd`.
