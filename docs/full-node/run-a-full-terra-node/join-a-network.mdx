...
| `jmes-888`   | Testnet | [Genesis Link](https://raw.githubusercontent.com/jmesworld/testnet/master/pisco-1/genesis.json) |  Peer List Community maintained by [JMES](https://raw.githubusercontent.com/mayoreee/jmes-genesis/master/genesis.json) | [Seeds List](https://github.com/jmesworld/testnet) |
...
wget https://raw.githubusercontent.com/mayoreee/jmes-genesis/master/addrbook.json -O ~/.jmes/config/addrbook.json
```
