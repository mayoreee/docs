...
To get 10 JMES, please paste this link in your browser:
...
| :---------- | :------ | :------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------- |
| `phoenix-1` | Mainnet | [Genesis Link](https://phoenix-genesis.s3.us-west-1.amazonaws.com/genesis.json)                   |  Peer List Community maintained by [Polkachu](https://polkachu.com/addrbooks/jmes)      | [Seeds List](https://github.com/jmesworld/mainnet#seed-nodes)                   |
...
Note that the versions of the network listed above are the [latest versions](https://github.com/jmesworld/testnet/tree/master#latest-networks). To find earlier versions, please consult the [networks repo](https://github.com/jmesworld/testnet).
