...
In order for JMESd to recognize a wallet address, it must contain tokens. For the testnet, use [the faucet](https://faucet.terra.money/) to send bJMES to your wallet. If you are on mainnet, send funds from an existing wallet. 1-3 bJMES are sufficient for most setup processes.
...
```bash
jmesd add-genesis-account $(jmesd keys show <account-name> -a) 100000000ubJMES
jmesd gentx <my-account> 10000000ubJMES --chain-id=<testnet-name>
...
| `pisco-1`   | Testnet | [Genesis Link](https://raw.githubusercontent.com/jmesworld/testnet/master/pisco-1/genesis.json) |  Peer List Community maintained by [Polkachu](https://polkachu.com/testnets/jmes/peers) | [Seeds List](https://github.com/jmesworld/testnet/tree/main/pisco-1#seed-nodes) |
