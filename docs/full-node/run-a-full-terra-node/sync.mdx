...
The process for syncing your full node from genesis will differ between the Pisco testnet and Udo mainnet networks. You may proceed with the instructions corresponding with your [chosen network](./join-a-network.mdx#join-a-public-network) below.

### Pisco testnet

If you would like to sync your node using the Pisco testnet, you will need to utilize version `v2.0.0-rc.0` of jmesd up until the block height of 838,500. To sync your node from block 838,500 until block 2,777,777, you will need to utilize version `v2.1.0-beta.1` of jmesd. From block 2,777,777 onwards, utilize version `v2.2.0` of jmesd.

1. To switch to version `v2.0.0-rc.0` of jmesd, [change into your `core` directory](./build-terra-core.mdx#get-the-terra-core-source-code) and execute the following commands in your terminal:
...
2. After you have the correct jmesd version, you will need to download the genesis file for Pisco in the jmesd config directory:

```
wget https://raw.githubusercontent.com/jmesworld/testnet/master/pisco-1/genesis.json -O ~/.terra/config/genesis.json
```
...
Syncing will halt at block 838,500, at which point you will need to change the version of jmesd and then resume the syncing process.

5. To sync your Pisco testnet node from block 838,500 to block 2,777,777, you will need to navigate to the `core` directory and change your jmesd version to `v2.1.0-beta.1`.
...
Syncing will halt at block 2,777,777, at which point you will need to change the version of jmesd and then resume the syncing process.

7. To sync your Pisco testnet node from block 2,777,777 to the most recent block, you will need to navigate to the `core` directory and change your jmesd version to `v2.2.0`.
...
Validators can view the status of the network using [JMES Finder](https://finder.terra.money).
