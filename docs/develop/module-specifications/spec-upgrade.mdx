...
JMES's upgrade module inherits from the Cosmos SDK's [`upgrade`](https://docs.cosmos.network/master/modules/upgrade/) module. This document is a stub and mainly covers important JMES-specific notes on how it is used.
