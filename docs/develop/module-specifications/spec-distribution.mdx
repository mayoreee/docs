...
JMES's distribution module inherits from Cosmos SDK's [`distribution`](https://docs.cosmos.network/master/modules/distribution/) module. This document is a stub and mainly covers important JMES-specific notes on how it is used.
...
Passive distribution means that validators and delegators need to manually collect their fee rewards by [submitting withdrawal transactions](../jmesd/subcommands.mdx#tx-distribution-withdraw-rewards).
...
The genesis parameters for the crisis module outlined in the [Genesis Builder Script](https://github.com/jmesworld/genesis-tools/blob/main/src/genesis_builder.py#L277) are as follows:
...
```py
   ...
   # Distribution: community pool
    ...
    add_module_account(
        ...
        'jmes1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8pm7utl',
