...
If you are an advanced user and want to learn about submitting or voting on proposals using JMESd, visit the [Governance section of the JMESd Reference](../terrad/subcommands.mdx#tx-gov-submit-proposal). 
...
[Delegators](../../learn/protocol.mdx#delegators) vote using their [staked bJMES](../../learn/protocol.mdx#staking). One staked bJMES equals one vote.
...
The minimum number of votes needed for a proposal to be valid. As of [JMES governance prop 3547](https://station.terra.money/proposal/3547), 30% of all staked bJMES must vote to reach `Quorum`. 
