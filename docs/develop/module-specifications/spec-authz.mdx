...
JMES's Authz module inherits from the Cosmos SDK's [`authz`](https://docs.cosmos.network/master/modules/authz/) module. This document is a stub and mainly explains important JMES-specific notes on how it is used.
