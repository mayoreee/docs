...
JMES's crisis module inherits from the Cosmos SDK's [`crisis`](https://docs.cosmos.network/master/modules/crisis/) module. This document is a stub and mainly covers important JMES-specific notes on how it is used.
...
The genesis parameters for the crisis module outlined in the [Genesis Builder Script](https://github.com/jmesworld/genesis-tools/blob/main/src/genesis_builder.py#L141) are as follows:
