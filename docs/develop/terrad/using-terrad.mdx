...
If you are not running a node and would like to communicate through JMESd, lists of public nodes can be found [here](../endpoints.mdx).
...
<details> 
<summary> Example: simulate a bJMES transfer: </summary>
<p>
