...
If you are interested in local development on Terra, it is recommended to utilize the LocalTerra network.  Please view the [LocalTerra documentation](../../develop/localjmes/README.mdx) for more information.
