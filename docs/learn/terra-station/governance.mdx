...
Governance is an important part of being involved in the Terra community. This tutorial walks you through how to vote on and submit governance proposals in Terra Station. For more information on governance and voting options, check out [the governance overview](../about/blockchain#governance).

## Vote on a proposal

Voting is an important process in which community members are able to have their say in the evolution of the Terra protocol. Follow the steps below to cast a vote with your staked Luna.
...
Users can vote on a proposal after a minimum deposit of 512 Luna is reached. To help push a proposal forward to a vote, you may deposit Luna to the proposal.

<Admonition type="caution" icon="☢️">

While most deposits get refunded, some deposits get burned. For more information on which deposits get burned, visit the [governance overview](../about/blockchain#governance).
...
3. Select the type of proposal, enter a title, a description, and the amount of Luna you will offer for initial deposit.

4. Enter your password and click **Submit**.

Your proposal will enter the two-week deposit period. After a minimum deposit of 512 Luna has been reached, your proposal will enter a one-week voting period. For more information on governance and voting options, visit the [governance overview](../about/blockchain#governance).
